...
<div class="container">
    ...
    <div class="row g-2 g-md-3 g-lg-4 mb-4">
        ...
        <div class="col-8 col-md-7 order-3">
            <h3 class="text-primary">Robert Fox</h3>

            <!-- user info -->
            <ul class="list-unstyled">
                <li class="text-muted lh-sm">Valencia, VE</li>
                <li class="text-muted lh-sm">(684) 555-0102</li>
                <li class="text-muted lh-sm">dolores.chambers@example.com</li>
