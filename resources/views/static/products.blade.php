            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="d-flex justify-content-between justify-content-lg-end align-items-center mt-3 mt-lg-0">
                        ...
                        <div>
                            <a href="#!" class="btn btn-success px-4 px-lg-5">Reservar</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center mb-3 mb-lg-0">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <a href="" class="text-reset font-weight-bold small lh-1" target="_blank">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="progress bg-light rounded" style="height: .5rem;">
                        <div class="progress-bar bg-danger rounded" style="width: 75%" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
