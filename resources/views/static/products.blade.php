...
@section('content')
<div class="container">
    <h1 class="text-primary font-weight-bold mb-4">Productos</h1>
    ...
    <article class="card mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="d-flex justify-content-between justify-content-lg-end align-items-center mt-3 mt-lg-0">
                        ...
                        <div>
                            <a href="#!" class="btn btn-primary px-4 px-lg-5">Reservar</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer py-3">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                    <div class="progress bg-light rounded" style="height: .75rem;">
                        <div class="progress-bar bg-danger rounded" style="width: 62.5%" role="progressbar" aria-valuenow="62.5" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
