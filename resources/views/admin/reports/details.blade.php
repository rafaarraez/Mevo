                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4">
                                            <div class="d-flex align-items-center mb-3 mb-lg-0">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <a href="https://www.google.com/maps/place/{{ $reserve->products->arrival_location }}" class="text-reset font-weight-bold small lh-1" target="_blank">
                                        ...
                                        <div class="col-6 col-lg-2">
                                            ...
                                            <div class="font-weight-bold small">
                                                <a href="{{ $reserve->products->coa }}" target="_blank">Adjunto</a>
                                            </div>
                                        </div>
                                        <div class="col-6 col-lg-2">
                                            <div class="text-muted small">MSDS</div>
                                            <div class="font-weight-bold small">
                                                <a href="{{ $reserve->products->msds }}" target="_blank">Adjunto</a>
                                            </div>
                                        </div>
                                        <div class="col-6 col-lg-2">
