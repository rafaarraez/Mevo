                        ...
                        <div class="card-footer bg-white py-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <div class="progress bg-light rounded-pill" style="height: .5rem;">
                                        <div class="progress-bar bg-success rounded-pill" style="width: {{ $product->total_disponible == null ? 100 : ($product->total_disponible*100)/$product->cantidad_total  }}%" role="progressbar" aria-valuenow="{{ $product->total_disponible == null ? $product->cantidad_total : $product->total_disponible  }}" aria-valuemin="0" aria-valuemax="{{$product->cantidad_total}}"></div>
                                    </div>
                                    <div class="small mt-1">
                                        <span class="text-muted">Disponibilidad:</span> <b>{{ $product->total_disponible == null ? $product->cantidad_total : $product->total_disponible  }} de {{$product->cantidad_total}}</b>
                                    </div>
                                </div>
                            </div>
                        </div>
